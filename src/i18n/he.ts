...
export const he: TranslationKeys = {
  ...
  shopping: {
    ...
    allDone: 'סיימת!',
    tapToCheck: 'החלק פריט שמאלה כשהוא אצלך',
    swipeForActions: 'החלק ימינה אם אזל מהמלאי - או לחץ ⋯ לאפשרויות נוספות',
    gotIt: 'נלקח',
    addItem: 'הוסף פריט',
    itemActions: 'אפשרויות עבור {{name}}',
    backToList: 'החזר לרשימה',
    remembered: 'שכחת משהו? הוסף אותו כאן בלי לצאת מהחנות.',
  ...
  categories: {
    ...
    shoppingOrderHint: 'גרור קטגוריה בעזרת הידית - או בחר בה והשתמש במקשי החיצים - כדי להתאים למסלול שלך בחנות. מצב הקניות יעקוב אחרי הסדר הזה.',
    reorder: 'שנה סדר',
    moveUp: 'העבר למעלה',
    moveDown: 'העבר למטה',
    resetOrder: 'אפס סדר',
  ...
  settings: {
    ...
    model: 'מודל',
    modelHint: 'משמש לקטגוריזציה חכמה',
    changeModel: 'שנה',
    chooseModel: 'בחר מודל',
    loadingModels: 'בודק אילו מודלים זמינים עם המפתח שלך...',
    modelsFailed: 'טעינת רשימת המודלים נכשלה',
